...
namespace Skladista
{
    public partial class Upravljanje_izdatnicom : Form
    {
        ...
        {
            int vrstaDokumenta = 2; // U bazi 2 pretstavlja izdatnicu
            using (var db = new PISkladiste2Entities())
            {
                List<interniDokument> izdatnica = (from t in db.interniDokument
                                                     where t.vrsta == vrstaDokumenta
                                                     select t).ToList();



                interniDokumentBindingSource.DataSource = izdatnica;
            }
        }
        ...
        private void Upravljanje_izdatnicom_Load(object sender, EventArgs e)
        {
            ...
            dtgPrikaz.DataError += dataGridView1_DataError;
        }
        ...
        {
            this.dtgPrikaz.DataSource = null;
        }
